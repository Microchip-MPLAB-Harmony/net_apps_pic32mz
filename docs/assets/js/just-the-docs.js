...
{"0": {
    ...
    "doc": "TCP/IP TCP MAC Bridge Application",
    ...
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_bridge/readme.html#tcpip-tcp-mac-bridge-application",
    "relUrl": "/apps/tcpip_tcp_server_bridge/readme.html#tcpip-tcp-mac-bridge-application"
  },"5": {
    "doc": "TCP/IP TCP MAC Bridge Application",
    "title": "Development kits",
    ...
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_bridge/readme.html#development-kits",
    "relUrl": "/apps/tcpip_tcp_server_bridge/readme.html#development-kits"
  },"6": {
    "doc": "TCP/IP TCP MAC Bridge Application",
    "title": "TCP/IP TCP MAC Bridge Application",
    "content": ". ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_bridge/readme.html",
    "relUrl": "/apps/tcpip_tcp_server_bridge/readme.html"
  },"7": {
    ...
    "doc": "TCP/IP TCP IPv4 Forwarding Applcation",
    "title": "TCP/IP TCP IPv4 Forwarding Application",
    "content": "The TCP Client configuration demonstrates creating a network client with the MPLAB Harmony TCP API to make a TCP/IP connection to a web server. ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_ipfwd/readme.html#tcpip-tcp-ipv4-forwarding-application",
    "relUrl": "/apps/tcpip_tcp_server_ipfwd/readme.html#tcpip-tcp-ipv4-forwarding-application"
  },"17": {
    "doc": "TCP/IP TCP IPv4 Forwarding Applcation",
    "title": "Development kits",
    "content": "The following table provides links to the documentation to the TCP/IP TCP Client Application on PIC32MZ EF &amp; DA family on both bare metal and FreeRTOS. | Development Kit | . | PIC32MZ Starter Kit MHC Configuration | . | PIC32MZ Starter Kit Hardware Configuration | . | PIC32MZ Starter Kit Run Application | . ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_ipfwd/readme.html#development-kits",
    "relUrl": "/apps/tcpip_tcp_server_ipfwd/readme.html#development-kits"
  },"18": {
    "doc": "TCP/IP TCP IPv4 Forwarding Applcation",
    "title": "TCP/IP TCP IPv4 Forwarding Applcation",
    "content": ". ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_ipfwd/readme.html",
    "relUrl": "/apps/tcpip_tcp_server_ipfwd/readme.html"
  },"19": {
    ...
    "doc": "Hardware Configuration",
    "title": "TCP/IP TCP MAC Bridge Hardware Configuration",
    "content": "This section describes PIC32MZ EF device hardware configuration for external Ethernet controller ENC624J600 with PIC32MZ2048EFH144 development board. | Refer to the PIC32MZ EF Ethernet Starter Kit User Guide . | Refer to the ENCX24j600 External Ethernet PICtail Plus Daughter Board [User Guide][https://www.microchip.com/developmenttools/ProductDetails/AC164132] . | Refer to Starter Kit I/O Expansion Board [User Guide][https://www.microchip.com/developmenttools/ProductDetails/DM320002] . | The Fast 100Mbps Ethernet PICtail Plus Daughter Board is inserted to J2(or J4) on the Starter Kit I/O Expansion Board. The J2, PICtail Plus (SPI) connector on Fast 100Mbps Ethernet PICtail Plus Daughter Board is attached to I/O Expansion Board with white arrows on the two boards lined up. The PICtail daughter board is inserted to use SPI1. | The PIC32MZ Embedded Connectivity with FPU (EF) Starter Kit is connected to J1 on the Starter Kit I/O Expansion board. | The pin 46 on J10 and pin 47 on J11 (on I/O Expansion board) need to be connected to control the Chip-Select line by the PIC32. | To power the set-up, connect the micro USB cable from the computer to the micro-A/B port J4 on the PIC32MZ EF Starter Kit . | For serial console, connect the mini USB cable from the computer to the USB-UART connector on the PIC32MZ EF Starter Kit . | . ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_bridge/docs/readme_hardware_configuration.html#tcpip-tcp-mac-bridge-hardware-configuration",
    "relUrl": "/apps/tcpip_tcp_server_bridge/docs/readme_hardware_configuration.html#tcpip-tcp-mac-bridge-hardware-configuration"
  },"116": {
    "doc": "Hardware Configuration",
    "title": "Hardware Configuration",
    "content": ". ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_bridge/docs/readme_hardware_configuration.html",
    "relUrl": "/apps/tcpip_tcp_server_bridge/docs/readme_hardware_configuration.html"
  },"117": {
    "doc": "Hardware Configuration",
    ...
    "title": "TCP/IP TCP MAC Bridge MHC Configuration",
    "content": "The following Project Graph diagram shows the Harmony components included in the TCP Client demonstration application. | MHC is launched by selecting Tools &gt; Embedded &gt; MPLAB® Harmony 3 Configurator from the MPLAB X IDE and after successful database migration , TCP/IP demo project is ready to be configured and regenerated. | TCP/IP Root Layer Project Graph . | TCP/IP stack module with external mac daughter board . Both ENC28j60 and ENCX24j600 daughter board use SPI1 driver and peripheral to communicate with the PIC32MZ EF controller. - . The root layer project shows that UART2 peripheral is selected to do read and write operation for TCP/IP commands. This is the basic configuration with SYS_CONSOLE, SYS_DEBUG and SYS_COMMAND modules. These modules are required for TCP/IP command execution. FreeRTOS component is required for RTOS application. For bare-metal (non-RTOS) FreeRTOS component should not be selected. TCP sockets calculate the ISN using the wolfSSL crypto library. | . | TCP/IP Required Application . TCP/IP demo use these application module components for this demo. Announce module to discover the Microchip devices within a local network. DHCP Client module to discover the IPv4 address from the nearest DHCP Server. DNS Client provides DNS resolution capabilities to the stack. | TCPIP Driver Layer . External ENCX24j600 ethernet driver . TCP/IP ENCx24j600 driver module selected for the external ethernet mac ENC28j60 device. For high MAC TX and RX performance DRV_ENCX24j600_MAC_TX_DESCRIPTORS and DRV_ENCX24j600_MAC_RX_DESCRIPTORS can be configured respectively more than the default descriptor value size “2”. | . ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_bridge/docs/readme_mhc_configuration.html#tcpip-tcp-mac-bridge-mhc-configuration",
    "relUrl": "/apps/tcpip_tcp_server_bridge/docs/readme_mhc_configuration.html#tcpip-tcp-mac-bridge-mhc-configuration"
  },"122": {
    "doc": "MHC Configuration",
    "title": "MHC Configuration",
    "content": ". ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_bridge/docs/readme_mhc_configuration.html",
    "relUrl": "/apps/tcpip_tcp_server_bridge/docs/readme_mhc_configuration.html"
  },"123": {
    "doc": "MHC Configuration",
    ...
    "doc": "MHC Configuration",
    "title": "TCP/IP TCP IPv4 Forwarding MHC Configuration",
    "content": "The following Project Graph diagram shows the Harmony components included in the TCP Client demonstration application. | MHC is launched by selecting Tools &gt; Embedded &gt; MPLAB® Harmony 3 Configurator from the MPLAB X IDE and after successful database migration , TCP/IP demo project is ready to be configured and regenerated. | TCP/IP Root Layer Project Graph . | TCP/IP stack module with external mac daughter board . Both ENC28j60 and ENCX24j600 daughter board use SPI1 driver and peripheral to communicate with the PIC32MZ EF controller. - . The root layer project shows that UART2 peripheral is selected to do read and write operation for TCP/IP commands. This is the basic configuration with SYS_CONSOLE, SYS_DEBUG and SYS_COMMAND modules. These modules are required for TCP/IP command execution. FreeRTOS component is required for RTOS application. For bare-metal (non-RTOS) FreeRTOS component should not be selected. TCP sockets calculate the ISN using the wolfSSL crypto library. | . | TCP/IP Required Application . TCP/IP demo use these application module components for this demo. Announce module to discover the Microchip devices within a local network. DHCP Client module to discover the IPv4 address from the nearest DHCP Server. DNS Client provides DNS resolution capabilities to the stack. | TCPIP Driver Layer . External ENCX24j600 ethernet driver . TCP/IP ENCx24j600 driver module selected for the external ethernet mac ENC28j60 device. For high MAC TX and RX performance DRV_ENCX24j600_MAC_TX_DESCRIPTORS and DRV_ENCX24j600_MAC_RX_DESCRIPTORS can be configured respectively more than the default descriptor value size “2”. | . ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_ipfwd/docs/readme_mhc_configuration.html#tcpip-tcp-ipv4-forwarding-mhc-configuration",
    "relUrl": "/apps/tcpip_tcp_server_ipfwd/docs/readme_mhc_configuration.html#tcpip-tcp-ipv4-forwarding-mhc-configuration"
  },"130": {
    "doc": "MHC Configuration",
    "title": "MHC Configuration",
    "content": ". ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_ipfwd/docs/readme_mhc_configuration.html",
    "relUrl": "/apps/tcpip_tcp_server_ipfwd/docs/readme_mhc_configuration.html"
  },"131": {
    "doc": "MHC Configuration",
    ...
    "doc": "Running Application",
    "title": "TCP/IP TCP MAC Bridge Running Application",
    "content": " ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_ipfwd/docs/readme_run_application.html#tcpip-tcp-mac-bridge-running-application",
    "relUrl": "/apps/tcpip_tcp_server_ipfwd/docs/readme_run_application.html#tcpip-tcp-mac-bridge-running-application"
  },"236": {
    "doc": "Running Application",
    "title": "MPLAB X IDE Project",
    "content": "This table list the name and location of the MPLAB X IDE project folder for the demonstration. | Project Name | Target Device | Target Development Board | Description | . | pic32mz_ef_sk_encx24j600.X | PIC32MZ2048EFH144 | PIC32MZ EF Starter Kit + External Ethernet Pictail Controller ENCx24j600 + I/O Expansion Board | Demonstrates the TCP/IP TCP MAC Bridge on development board with PIC32MZ2048EFH144 device and external Ethernet controller ENCx24j600. This is a bare-metal (non-RTOS) implementation | . ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_ipfwd/docs/readme_run_application.html#mplab-x-ide-project",
    "relUrl": "/apps/tcpip_tcp_server_ipfwd/docs/readme_run_application.html#mplab-x-ide-project"
  },"237": {
    "doc": "Running Application",
    "title": "Running The Demonstration",
    "content": ". | Configure the Development Board as given Configure Hardware. | Make the demonstration setup as shown Network Setup. | Build and download the demonstration project on the target board. | If the board has a UART connection: . | A virtual COM port will be detected on the computer, when the USB cable is connected to USB-UART connector. | Open a standard terminal application on the computer (like Hyper-terminal or Tera Term) and configure the virtual COM port. | Set the serial baud rate to 115200 baud in the terminal application. | See that the initialization prints on the serial port terminal. | When the DHCP client is enabled in the demonstration, wait for the DHCP server to assign an IP address for the development board. This will be printed on the serial port terminal. | Alternatively: Use the Announce service or ping to get the IP address of the board. | Run tcpip_discoverer.jar to discover the IPv4 and IPv6 address for the board. | . | . | Execution : . | After the successful broad bring up, the console output becomes . | For TCP Client test, input the following command from the serial port: . | . | openurl &lt; url &gt; - The &lt; url &gt; argument must be a fully formed URL; for instance, http://www.microchip.com/. | For this above URL , the DNS module will make a DNS query. Then it will open a connection to the requested URL and perform a simple HTTP GET command. | The response received from the server will be printed on the terminal application through the serial port. The expected output - . | . | . ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_ipfwd/docs/readme_run_application.html#running-the-demonstration",
    "relUrl": "/apps/tcpip_tcp_server_ipfwd/docs/readme_run_application.html#running-the-demonstration"
  },"238": {
    "doc": "Running Application",
    "title": "Running Application",
    "content": ". ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_ipfwd/docs/readme_run_application.html",
    "relUrl": "/apps/tcpip_tcp_server_ipfwd/docs/readme_run_application.html"
  },"239": {
    "doc": "Running Application",
    ...
    "title": "TCP/IP TCP MAC Bridge Running Application",
    "content": " ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_bridge/docs/readme_run_application.html#tcpip-tcp-mac-bridge-running-application",
    "relUrl": "/apps/tcpip_tcp_server_bridge/docs/readme_run_application.html#tcpip-tcp-mac-bridge-running-application"
  },"252": {
    "doc": "Running Application",
    "title": "MPLAB X IDE Project",
    "content": "This table list the name and location of the MPLAB X IDE project folder for the demonstration. | Project Name | Target Device | Target Development Board | Description | . | pic32mz_ef_sk_encx24j600.X | PIC32MZ2048EFH144 | PIC32MZ EF Starter Kit + External Ethernet Pictail Controller ENCx24j600 + I/O Expansion Board | Demonstrates the TCP/IP TCP MAC Bridge on development board with PIC32MZ2048EFH144 device and external Ethernet controller ENCx24j600. This is a bare-metal (non-RTOS) implementation | . ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_bridge/docs/readme_run_application.html#mplab-x-ide-project",
    "relUrl": "/apps/tcpip_tcp_server_bridge/docs/readme_run_application.html#mplab-x-ide-project"
  },"253": {
    "doc": "Running Application",
    "title": "Running The Demonstration",
    "content": ". | Configure the Development Board as given Configure Hardware. | Make the demonstration setup as shown Network Setup. | Build and download the demonstration project on the target board. | If the board has a UART connection: . | A virtual COM port will be detected on the computer, when the USB cable is connected to USB-UART connector. | Open a standard terminal application on the computer (like Hyper-terminal or Tera Term) and configure the virtual COM port. | Set the serial baud rate to 115200 baud in the terminal application. | See that the initialization prints on the serial port terminal. | When the DHCP client is enabled in the demonstration, wait for the DHCP server to assign an IP address for the development board. This will be printed on the serial port terminal. | Alternatively: Use the Announce service or ping to get the IP address of the board. | Run tcpip_discoverer.jar to discover the IPv4 and IPv6 address for the board. | . | . | Execution : . | After the successful broad bring up, the console output becomes . | For TCP Client test, input the following command from the serial port: . | . | openurl &lt; url &gt; - The &lt; url &gt; argument must be a fully formed URL; for instance, http://www.microchip.com/. | For this above URL , the DNS module will make a DNS query. Then it will open a connection to the requested URL and perform a simple HTTP GET command. | The response received from the server will be printed on the terminal application through the serial port. The expected output - . | . | . ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_bridge/docs/readme_run_application.html#running-the-demonstration",
    "relUrl": "/apps/tcpip_tcp_server_bridge/docs/readme_run_application.html#running-the-demonstration"
  },"254": {
    "doc": "Running Application",
    "title": "Running Application",
    "content": ". ",
    "url": "http://localhost:4000/net_apps_pic32mz/apps/tcpip_tcp_server_bridge/docs/readme_run_application.html",
    "relUrl": "/apps/tcpip_tcp_server_bridge/docs/readme_run_application.html"
  },"255": {
    "doc": "Running Application",
